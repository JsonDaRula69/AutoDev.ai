...
- [x] 16. Build auto-merge, boulder state, and continuation loops
...
- [x] 20. Fill in 5 integration module stubs (lsp, tmux, mcp-integrations, rules-injection, watch-officer-monitor)
